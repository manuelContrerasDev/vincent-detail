...
export function BenefitsSection() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(214,178,94,0.07),transparent_20%)]" />
      <div className="absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(214,178,94,0.22),transparent)]" />
      <div className="absolute inset-x-0 bottom-0 h-px bg-[linear-gradient(90deg,transparent,rgba(214,178,94,0.14),transparent)]" />
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 md:gap-x-5">
            {topHighlights.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className="h-3.5 w-3.5 text-[#D6B25E]" />
      ...
      <div className="relative mt-5 md:mt-6">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-16 bg-[linear-gradient(90deg,#070707,rgba(7,7,7,0))] md:w-28" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-16 bg-[linear-gradient(270deg,#070707,rgba(7,7,7,0))] md:w-28" />
          ...
          <div className="group marquee-track group-hover:[animation-play-state:paused]">
            {marqueeItems.map((item, index) => (
              ...
              >
                ...
                <span className="ml-4 text-[#D6B25E]/70 md:ml-6">•</span>
              </div>
            ))}
          </div>
        </div>
