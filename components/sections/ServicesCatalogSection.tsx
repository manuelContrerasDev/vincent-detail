...
export function ServicesCatalogSection() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(242,213,138,0.06),transparent_22%)]"
      />
      ...
      <SectionContainer className="relative">
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.66),rgba(0,0,0,0.58),rgba(0,0,0,0.78))]"
          />
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(242,213,138,0.08),transparent_24%)]"
          />
              ...
              {services.map((service) => {
                ...
                return (
                  <li key={service.title}>
                    <div className="grid gap-4 bg-black/18 px-5 py-5 transition duration-300 hover:bg-black/32 md:grid-cols-[1.25fr_0.65fr_0.85fr] md:items-center md:px-6">
